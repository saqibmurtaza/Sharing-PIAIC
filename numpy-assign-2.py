...
def function11():
    ...
    arr[1::2]= -1 #write your code here 
    ans = arr
    return ans
...
def function15():
    ...
    ans = arr[[0, 1, 2],:] = arr[[1, 0, 2],:] #write your code here 
...
y = np.where((arr%3==0) & (arr%5==0),'YES','NO')
return y         # Write Your Code HERE
...
def function18():
    ...
    x =  np.size([np.where(students<100)]) # Write you code Here
    return x
